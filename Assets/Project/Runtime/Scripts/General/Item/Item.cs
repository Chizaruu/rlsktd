...
namespace RLSKTD.General.Item{
    ...
    public class Item {
        ...
        public Item(string name, string description, Material.MaterialEnum material, Quality.QualityEnum quality, float weight, bool isIdentified, int value, UnityEngine.Color color) {
            Name = name;
