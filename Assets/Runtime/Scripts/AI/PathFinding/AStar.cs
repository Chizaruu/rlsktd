...
/// <summary> Pathfinding Algorithms. </summary>
namespace RLSKTD.AI.Pathfinding
{
    ...
    public class AStar : MonoBehaviour
    {
        ...
        public Stack<Vector3Int> Algorithm(Vector3 startPosition, Vector3 goalPosition)
        {
            ...
            while (openList.Count > 0 && path == null)
            {
                ...
                ExamineNeighbours(neighbours, current, GameManager.instance.DiagonalMovement); // Examine neighbours
        ...
        private void ExamineNeighbours(List<Node> neighbours, Node current, bool noDiagonalMovement)
        {
            // For each neighbour
            for(int i = 0; i < neighbours.Count; i++)
            {
                ...
                if(!ConnectedDiagonally(current, neighbour) && noDiagonalMovement)
                {
                    continue; // Skip
                }
